...
class GuessesControllerTest < ActionController::TestCase
  ...
  test "should create guess" do
    assert_difference('Guess.count') do
      post :create, guess: { common_name: @guess.common_name, correct: @guess.correct, family: @guess.family, image_id: @guess.image_id, suborder: @guess.suborder, user_id: @guess.user_id }
    end
  ...
  test "should update guess" do
    put :update, id: @guess, guess: { common_name: @guess.common_name, correct: @guess.correct, family: @guess.family, image_id: @guess.image_id, suborder: @guess.suborder, user_id: @guess.user_id }
    assert_redirected_to guess_path(assigns(:guess))
  end
