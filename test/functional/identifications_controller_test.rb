...
class IdentificationsControllerTest < ActionController::TestCase
  ...
  test "should create identification" do
    assert_difference('Identification.count') do
      post :create, identification: { common_name: @identification.common_name, family: @identification.family, image_id: @identification.image_id, number: @identification.number, suborder: @identification.suborder, user_id: @identification.user_id }
    end
  ...
  test "should update identification" do
    put :update, id: @identification, identification: { common_name: @identification.common_name, family: @identification.family, image_id: @identification.image_id, number: @identification.number, suborder: @identification.suborder, user_id: @identification.user_id }
    assert_redirected_to identification_path(assigns(:identification))
  end
